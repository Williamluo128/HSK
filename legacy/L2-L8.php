...
<div class="container-fluid">
	...
	<h4 class="textSection">Kè wén yī. Zài jiàoshì.<br/>课文一。 在 教室。<br/>Text 1. In the classroom.</h4>
	...
	<h4 class="textSection">Kè wén èr. Zài sùshè.<br/>课文二。在宿舍。<br/>Text 2. In then Dorm.</h4>
	<div class="col-xs-12 col-md-6 col">
	...
	<h4 class="textSection">Kè wén sān. Zài bīnguǎn de qiántái.<br/>课文三。在 宾馆 的 前台。<br/>Text 3. At the front desk of a hotel.</h4>
	<div class="col-xs-12 col-md-6 col">
	...
	<h4 class="textSection">Kè wén sì. Zài shāngdiàn.<br/>课文四。在 商店。<br/>Text 4. In a store.</h4>
	<div class="col-xs-12 col-md-6 col">
